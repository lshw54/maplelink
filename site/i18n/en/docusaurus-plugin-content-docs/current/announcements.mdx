...
These are the same notices the app shows, newest first. Inside the app they can be reread under Toolbox → Announcements.
...
<p className="tl-links"><a href="/en/download#verify">How to verify a download</a></p>
