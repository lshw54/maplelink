...
Neither needs installing. Either runs from any folder. Settings and accounts live in `%APPDATA%\com.maplelink.app`, not next to the program; see the [guide](/guide).

## Requirements

- Windows 10 or 11 (64-bit)
- Microsoft Edge WebView2. Usually preinstalled; [how to add it](/faq#webview2) if missing
