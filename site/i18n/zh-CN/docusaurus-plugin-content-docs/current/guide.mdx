...
到[下载页](/download)。第一次使用请选 **MapleLink-Setup.exe**，其他情况见该页的「选择文件」。

:::tip 只从本站或 GitHub Releases 下载
从其他地方取得的文件都不是我们发出的。下载后可以[核对 SHA256](/download#verify)。
:::
## 2. 解压并放好
...
<details>
<summary>Windows 显示「无法识别的应用」</summary>
...
<details>
<summary>窗口全白，或一打开就关闭</summary>

电脑缺少 WebView2。依[常见问题的步骤](/faq#webview2)安装，约一分钟。

<DemoBlank />

</details>
<details>
<summary>出现一段公告</summary>
...
<details>
<summary>程序询问是否改名为 Beanfun.exe</summary>
...
还没有安装游戏，或客户端损坏需要修复，见[游戏客户端](/client)。
...
<details>
<summary>只想启动游戏，在游戏内自行登录</summary>
...
遇到问题请先查看[常见问题](/faq)；找不到答案，到 [GitHub Issues](https://github.com/lshw54/maplelink/issues) 反馈。
