...
Neither needs installing. Either runs from any folder. Settings and accounts live in `%APPDATA%\com.maplelink.app`, not next to the program; see the [guide](/en/guide/#_2-unpack-and-keep-it).
