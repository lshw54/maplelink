...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::account::add_service_account,
            commands::account::get_service_contract,
            commands::account::get_account_limit,
            ...
            commands::browser::browser_bookmarks,
            commands::browser::browser_toolbar_ready,
            commands::browser::browser_connection_info,
            ...
            commands::auth::classic_self_check,
            commands::auth::classic_accounts_found,
            commands::auth::classic_pick_account,
